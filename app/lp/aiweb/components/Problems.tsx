      ...
      <div className="container mx-auto px-4 relative">
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-8 md:w-[35%] relative">
                  <div className="flex flex-col h-full">
                    <div
                      className={`${bgColor} ${color} p-4 rounded-xl group-hover:scale-110 transition-transform duration-500 self-start`}
                    >
                ...
                <div className="relative md:w-[10%] flex items-center justify-center py-6 md:py-0">
                  <div
                    className={`${bgColor} rounded-full p-4 shadow-lg group-hover:scale-110 transition-transform duration-500`}
                  >
                    <ArrowRight className={`w-8 h-8 ${color} hidden md:block`} />
                    <ArrowDown className={`w-8 h-8 ${color} md:hidden`} />
                  </div>
                  <div className="absolute inset-0 flex items-center">
                    <div className={`h-0.5 w-full ${bgColor} hidden md:block`} />
                  </div>
                </div>
                ...
                <div className={`p-8 md:w-[55%] bg-gradient-to-br ${gradient}`}>
                  <div className="flex flex-col h-full">
                    <div
                      className={`bg-white ${color} p-4 rounded-xl group-hover:scale-110 transition-transform duration-500 self-start`}
                    >
        ...
        <div className="mt-16 text-center">
          <div className="inline-block relative group">
            {/* Main Button */}
            <CTAButton showStats={true} stats={[{ value: '24h', label: '対応' }]} />
          </div>
        </div>
      </div>
    </section>
